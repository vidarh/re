...
module Rouge
  ...
  state :sigil_strings do
        ...
        # FIXME: To be able to avoid this, we'd really like to be able to
        # find some way of hooking into an arbitrary *state*.
        # Could possibly override the sigil_strings state?
      ...
      state :root do
        mixin :whitespace
        rule /^=begin/, Comment::Multiline, :multiline
